...
puts "            <input type=\"text\" inputmode=\"email\" id=\"email\" name=\"email\" value=\"#{CGI.escapeHTML(email)}\" pattern=\"[a-z0-9._%+\\-]+@[a-z0-9.\\-]+\\.[a-z]{2,4}\" title=\"Please enter a valid email address (e.g. user@example.com)\" required>"
